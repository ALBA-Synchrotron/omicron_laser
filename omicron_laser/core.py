...
class Status:
    ...
    def __repr__(self) -> str:
        ...
        self.toggle_key, self.system_power, self.external_sensor_connected)    
...
class LatchedFailure:
    ...
    def __repr__(self) -> str:
        ...
        self.internal_comunication_error, self.k1_relay_error, self.high_power,
        self.under_over_voltage, self.external_interlock, self.diode_current, 
...
class OperationMode:
    ...
    def __repr__(self) -> str:
        return """{{
            ...
            "auto_startup", {},
            "auto_powerup", {}
        }}""".format(self.internal_clock_generator, 
    ...
    def __bytes__(self) -> bytes:
        b = self.internal_clock_generator << 2 | \
